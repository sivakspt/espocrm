	...
	<form id="nav">
		<div class="row">
			...
			<div class="cell cell-website pull-right" align="right">
				<a target="_blank" href="http://blog.AppsZure.com/administration/server-configuration-for-AppsZure/" style="font-weight:bold;">{$langs['labels']['Configuration Instructions']}</a>
			</div>
