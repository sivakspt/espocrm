...
abstract class Base
{
    ...
    /**
     * Check if version of upgrade/extension is acceptable to current version of AppsZure
     *
    ...
    protected function checkVersions()
    {
        ...
        $this->throwErrorAndRemovePackage('Your AppsZure version doesn\'t match for this installation package.');
    }
